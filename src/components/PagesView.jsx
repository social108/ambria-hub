...
export default function PagesView({ allEvents }) {
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: mob ? 11 : 13, color: "#9ca3af", marginBottom: 20 }}>All 8 pages at a glance — click to open on Instagram</p>
      <div style={{ display: "grid", gridTemplateColumns: `repeat(auto-fill, minmax(${mob ? "240px" : "300px"}, 1fr))`, gap: 12 }}>
        {PAGES.map(pg => (
          <a key={pg.id} href={pg.url} target="_blank" rel="noopener noreferrer" style={{
            ...
            borderRadius: 14, padding: mob ? 14 : 20, transition: "all 0.25s", display: "block",
